"""designintime_17435 URL Configuration
...
admin.site.site_header = "designintime"
admin.site.site_title = "designintime Admin Portal"
admin.site.index_title = "designintime Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="designintime API",
        default_version="v1",
        description="API documentation for designintime App",
    ),
    public=True,
